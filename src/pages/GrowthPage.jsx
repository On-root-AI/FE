  ...
  return (
    <MobileScreenLayout scrollable background="chat">
      ...
      <div style={{ 
        ...
        <h1 style={{ fontSize: '18px', fontWeight: '500', color: '#44473c', margin: '16px 0 24px 0', textAlign: 'center', lineHeight: '1.4' }}>
          한 걸음씩 꾸준히, 나만의 열매 <br />
          <span style={{ fontSize: '22px', color: '#8b9f5b', fontWeight: '600' }}>‘온루’</span>를 향해
        </h1>
        ...
        <div style={{
          ...
          <GrowthStageCard range="0~5" title="씨앗" imgSrc={seedImg} isActive={checkActiveStage(0, 5)} />
          <GrowthStageCard range="6~15" title="새싹" imgSrc={sproutImg} isActive={checkActiveStage(6, 15)} />
          <GrowthStageCard range="16~25" title="나무" imgSrc={treeImg} isActive={checkActiveStage(16, 25)} />
          <GrowthStageCard range="26~30±" title="온루 열매" imgSrc={fruitImg} isActive={streakDays >= 26} />
        </div>
